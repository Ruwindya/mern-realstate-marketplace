...
const handleSubmit = async (e) =>{
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      <div>
      <h1 className='text-green-500 text-3xl font-semibold text-center '>Update Your Listing</h1>
      <h1 className='text-black-500 text-xl font-semibold text-center my-7'>Update your listing here</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <button disabled={loading || uploading} className='p-3 font-bold text-white 
             ...
             hover:opacity-60 disabled:opacity-60'>{loading ? 'Updating':'Update Listing'}</button>
